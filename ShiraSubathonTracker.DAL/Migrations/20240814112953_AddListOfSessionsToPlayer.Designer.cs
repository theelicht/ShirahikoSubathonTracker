...
namespace ShiraSubathonTracker.DAL.Migrations
{
    ...
    [Migration("20240814112953_AddListOfSessionsToPlayer")]
    partial class AddListOfSessionsToPlayer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiraSubathonTracker.DAL.Entities.Minecraft.PlaytimeStatisticsByTimestamp", b =>
                {
                    b.Property<string>("IpAddress")
                        .HasMaxLength(40)
                        .HasColumnType("nvarchar(40)");
                    ...
                    b.Property<double>("TotalMinutesPlayed")
                        .HasColumnType("float");

                    b.HasKey("IpAddress", "Timestamp", "GroupingType");

                    b.ToTable("PlaytimeStatisticsByTimestamps");
                });
            ...
            modelBuilder.Entity("ShiraSubathonTracker.DAL.Entities.Minecraft.PlaytimeStatisticsByTimestamp", b =>
                {
                    b.HasOne("ShiraSubathonTracker.DAL.Entities.Minecraft.MinecraftServer", "MinecraftServer")
                        .WithMany()
                        .HasForeignKey("IpAddress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MinecraftServer");
                });
